<table class="ctable" border="0" cellpadding="2" cellspacing="0">
    ...
    <tr style="font-weight: bolder;">
        ...
        <th colspan="7" style="text-align: left;">Работы</th>
    ...
    <tr style="font-weight: bolder;">
        ...
        <th colspan="7" style="text-align: left;">Готовая продукция</th>
    ...
    <tr style="font-weight: bolder;">
        ...
        <th colspan="7" style="text-align: left;">Исполнители</th>
    ...
    <tr style="font-weight: bolder;">
        ...
        <th colspan="7" style="text-align: left;">Оборудование</th>
